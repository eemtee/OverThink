import speech_recognition as sr # speech reco..
import playsound # audio player
import random
import ssl
import certifi
...
def respond(voice_data):
    # 1: greeting
    if there_exists(['hey','hi','hello', 'good evening']):
    ...
    if there_exists(["my name is" , "name's", "name is"]):
    ...
    if there_exists(["toss","flip","coin"]):
        ...
        cmove=random.choice(moves)
        engine_speak("The computer chose " + cmove)
        engine_speak("Toss a coin to your witcher, O'valey of plenty")

     #calculator
    if there_exists(["plus","minus","multiply with","divided by","power","+","-","*","/"]):
    ...
    if there_exists(["capture","my screen","screenshot"]):
        ...
        engine_speak("Screen Captured")
        myScreenshot.save('/home/eemtee/Desktop/screen.png')
